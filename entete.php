...
<html>
    <header>
        <div id="naviguation">
                ...
                <div id="icone"><a href="parametre_compte.php"><img src="images/icone.jpg" alt="icone" style="border-radius: 110px;width:45px; position:absolute;top:30px;right:185px;margin-right:10px"></a></div>
